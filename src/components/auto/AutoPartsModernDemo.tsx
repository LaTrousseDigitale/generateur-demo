      ...
      <section className="py-8">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              {/* Background image with red auto parts */}
              <div className="absolute inset-0">
                <img 
                  src={promoAutoPartsRed} 
                  alt="Pièces automobiles" 
                  className="w-full h-full object-cover"
                />
                <div 
                  className="absolute inset-0" 
                  style={{ background: `linear-gradient(135deg, ${config.primaryColor}cc, ${config.accentColor || '#f97316'}99)` }}
                />
              </div>
            ...
            <Card 
              className="relative overflow-hidden rounded-2xl p-8 text-white min-h-[200px]"
            >
              {/* Background image with dark auto parts */}
              <div className="absolute inset-0">
                <img 
                  src={promoAutoPartsDark} 
                  alt="Pièces automobiles" 
                  className="w-full h-full object-cover"
                />
                <div className="absolute inset-0 bg-slate-900/60" />
                {/* Red accent glow */}
                <div className="absolute -right-10 -top-10 w-40 h-40 rounded-full opacity-30" style={{ backgroundColor: config.primaryColor, filter: 'blur(40px)' }}/>
              </div>
              <div className="relative z-10">
        ...
        <section className="py-16 bg-slate-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-8">
              ...
              <p className="text-slate-500 mt-2">Suivez et gérez vos garanties en un seul endroit</p>
            </div>
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="bg-white border border-slate-200 rounded-xl p-6 text-center hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div 
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-2">Garantie standard</h3>
                <p className="text-slate-500 text-sm mb-4">2 ans sur toutes les pièces OEM</p>
                <ul className="text-left text-sm text-slate-600 space-y-2 mb-6">
                  ...
                  <li className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: config.primaryColor }} />
                    Installation certifiée requise
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: config.primaryColor }} />
              ...
              <Card className="bg-white border-2 rounded-xl p-6 text-center relative overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300" style={{ borderColor: config.primaryColor }}>
                <Badge 
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-2">Garantie étendue</h3>
                <p className="text-slate-500 text-sm mb-4">5 ans avec couverture complète</p>
                <ul className="text-left text-sm text-slate-600 space-y-2 mb-6">
                  <li className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: config.primaryColor }} />
                    Toutes pièces OEM & aftermarket
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: config.primaryColor }} />
              ...
              <Card className="bg-white border border-slate-200 rounded-xl p-6 text-center hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <div 
                  className="w-16 h-16 mx-auto rounded-xl flex items-center justify-center mb-4"
                  style={{ backgroundColor: `${config.accentColor || '#f97316'}15` }}
                >
                  <RotateCcw className="w-8 h-8" style={{ color: config.accentColor || '#f97316' }} />
                </div>
                <h3 className="text-xl font-bold text-slate-900 mb-2">Suivi des garanties</h3>
                <p className="text-slate-500 text-sm mb-4">Tableau de bord personnalisé</p>
                <ul className="text-left text-sm text-slate-600 space-y-2 mb-6">
                  <li className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: config.accentColor || '#f97316' }} />
