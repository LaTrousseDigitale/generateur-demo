          ...
          <div className="max-w-2xl">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button 
                ...
                className="h-14 px-8"
                style={{ 
                  borderColor: isLightTheme ? config.primaryColor : 'rgba(255,255,255,0.3)',
                  color: isLightTheme ? config.primaryColor : 'white',
      ...
      >
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Button 
              size="lg"
              className="h-14 px-8 font-bold border-2 border-white text-white bg-white/10 hover:bg-white/20"
            >
              <Phone className="w-5 h-5 mr-2" />
              514-555-0123
            </Button>
