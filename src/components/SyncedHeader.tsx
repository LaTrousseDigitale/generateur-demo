      ...
      <div className="w-full max-w-[1400px] mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-[72px]">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* CTA Button */}
            <Button 
              className="hidden sm:flex !bg-[#ff6b3d] hover:!bg-[#e55a2d] text-white rounded-md px-5 py-2.5 text-[14px] font-medium items-center gap-2"
              onClick={onCtaClick}
            >
        ...
        {mobileMenuOpen && (
          <nav className="md:hidden py-4 border-t border-gray-100">
            <div className="flex flex-col gap-3">
              ...
              <Button 
                className="!bg-[#ff6b3d] hover:!bg-[#e55a2d] text-white rounded-md px-5 py-2.5 text-[14px] font-medium flex items-center gap-2 mt-2"
                onClick={onCtaClick}
              >
                <Sparkles className="h-4 w-4" />
                Générer ma démo
