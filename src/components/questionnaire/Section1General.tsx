...
const INDUSTRY_OBJECTIVES: Record<string, string[]> = {
  auto: [
    "Vendre des pièces en ligne 24/7",
    "Faciliter la recherche de pièces par compatibilité",
    "Attirer plus de clients (particuliers ou garages)",
    "Gérer l'inventaire efficacement",
    "Afficher les prix et disponibilités en temps réel",
  ],
  restauration: [
    "Augmenter les réservations en ligne",
    "Permettre les commandes en ligne (livraison/emporter)",
  ...
  commerce: [
    ...
    "Fidéliser les clients avec un programme de points",
    "Gérer les promotions et soldes facilement",
  ],
  sante: [
    "Permettre la prise de rendez-vous en ligne",
    "Offrir un portail patient sécurisé",
    "Envoyer des rappels automatiques",
    "Gérer les dossiers patients (conformité)",
    "Proposer la téléconsultation",
  ],
  construction: [
    "Présenter les projets réalisés (portfolio)",
    "Générer des demandes de soumission",
    "Gérer les projets et chantiers",
    "Communiquer avec les clients sur l'avancement",
    "Gérer les sous-traitants",
  ],
  education: [
    "Créer un portail étudiant",
    "Gérer les inscriptions en ligne",
    "Offrir des cours ou formations en ligne",
    "Suivre la progression des étudiants",
    "Communiquer avec parents et étudiants",
  ],
  obnl: [
    ...
    "Publier des rapports et nouvelles",
  ],
  services: [
    "Générer des prospects qualifiés",
    "Présenter les services de façon professionnelle",
    "Permettre les prises de rendez-vous",
    "Automatiser les suivis clients",
    "Afficher les témoignages clients",
  ],
  architecture: [
    "Mettre en valeur le portfolio de projets",
    "Présenter l'équipe et l'expertise",
    "Générer des demandes de consultation",
    "Partager des études de cas détaillées",
    "Montrer le processus de travail",
  ],
  tech: [
    "Générer des prospects B2B",
    "Présenter les solutions/produits tech",
    "Offrir une documentation en ligne",
    "Permettre les démos ou essais gratuits",
    "Intégrer un système de tickets support",
  ],
  transport: [
    "Permettre les réservations/demandes de transport",
    "Afficher les tarifs et zones desservies",
  ...
  "arts-scene": [
    ...
    "Présenter les spectacles et artistes",
...
const DEFAULT_OBJECTIVES = [
  "Augmenter les ventes ou conversions",
  "Améliorer la visibilité en ligne",
  "Automatiser des processus manuels",
