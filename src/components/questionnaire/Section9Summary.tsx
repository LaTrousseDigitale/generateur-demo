...
export const Section9Summary = ({
  ...
  return <div className="space-y-6">
      ...
      <Card className="p-4 bg-primary/5 border-primary/20">
        <p className="text-sm">Presque terminé ! Une fois que vous aurez cliqué sur ''suivant'', vous accéderez à votre démo en temps réel ainsi qu'un devis personnalisé de votre projet. Pour toute question, n'hésitez pas à nous joindre du lundi au jeudi de 11h à 19h et les vendredi entre 10h et 14h. Nous vous répondrons dans un délai de 24 heures ouvrables.                                                                                                                                 re équipe vous contactera selon votre préférence pour discuter de votre projet.                                                                                                                                    <strong>Presque terminé !</strong> Une fois que vous aurez vu votre démo personnalisée, vous recevrez un
